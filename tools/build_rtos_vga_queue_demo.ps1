param(
  ...
  [string]$OutName = "rtos_vga_queue_demo",
...
$required = @(
  ...
  (Join-Path $repoRoot "OS\rtos\src\main_vga_queue_demo.c"),
  (Join-Path $repoRoot "game\vga_fb.h"),
  (Join-Path $repoRoot "game\vga_fb.c"),
