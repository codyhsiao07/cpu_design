...
# Clock signal (board_top.clk_in)
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clk_in }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {clk_in}];

# DDR2 / MIG clocks (NOT in this template)
# TODO: add DDR2 pin constraints from MIG IP or board-specific DDR2 XDC.
# TODO: assign sys_clk_p/sys_clk_n/clk_ref_i to the correct board pins.
...
## LEDs (use for status / debug)
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { status_o[0] }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { status_o[1] }]; #IO_L24P_T3_RS1_15 Sch=led[1]
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { ifetch_err_o }]; #IO_L17N_T2_A25_15 Sch=led[2]
...
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { uart_rx_i }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out
