## Basys3 essential constraints for basys3_top
## Clock
...
## Reset push button (BTN_C, active-high)
...
## Configuration options required by Digilent reference designs
